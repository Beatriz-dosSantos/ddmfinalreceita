...
import { getRecipeById, deleteRecipeById } from '../services/recipes';
...
export default function DetalhesReceita() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity
        style={[styles.editButton, { backgroundColor: '#D9849F', marginTop: 12 }]}
        onPress={() => setShowModal(true)}
      >
        <Text style={styles.editButtonText}>Excluir Receita</Text>
      </TouchableOpacity>
